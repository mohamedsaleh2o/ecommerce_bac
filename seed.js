...
// Add 70 more products dynamically to reach 100
const categories = ["smartphones", "smartwatches", "men's clothing", "women's clothing", "electronics", "jewelery"];
const adjectives = ["Premium", "Essential", "Pro", "Ultra", "Classic", "Modern", "Sleek", "Rugged", "Lite", "Elite"];
const nouns = {
  "smartphones": ["Phone", "Device", "Communicator", "Mobile", "Cell"],
  "smartwatches": ["Watch", "Tracker", "Band", "Timepiece", "Wearable"],
  "men's clothing": ["T-Shirt", "Jacket", "Pants", "Hoodie", "Shorts"],
  "women's clothing": ["Dress", "Blouse", "Skirt", "Leggings", "Sweater"],
  "electronics": ["Laptop", "Earbuds", "Speaker", "Tablet", "Monitor"],
  "jewelery": ["Ring", "Necklace", "Bracelet", "Earrings", "Pendant"]
};

// Generic fallback images from unsplash by category
const images = {
  "smartphones": "https://images.unsplash.com/photo-1523206489230-c012c64b2b48?q=80&w=800&auto=format&fit=crop",
  "smartwatches": "https://images.unsplash.com/photo-1508685096489-7aacd43bd3b1?q=80&w=800&auto=format&fit=crop",
...
for (let i = 31; i <= 100; i++) {
  ...
  dummyProducts.push({
    id: i,
    title: `${adj} ${noun} ${Math.floor(Math.random() * 10) + 1}`,
    price: parseFloat((Math.random() * 500 + 20).toFixed(2)),
    description: `A highly rated and requested ${noun.toLowerCase()} from our ${category} collection. Features the latest design standards and premium materials.`,
    category: category,
...
const startSeed = async () => {
    try {
        ...
        console.log(`Inserting ${dummyProducts.length} dummy products...`);
